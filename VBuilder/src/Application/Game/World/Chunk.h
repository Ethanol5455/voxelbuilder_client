...
public:
	...
	void SetNeighborChunks(Chunk* top, Chunk* bottom, Chunk* left, Chunk* right, Chunk* back, Chunk* front);
	...
	void BuildMesh();
	const bool& IsMeshUpToDate() { return m_IsMeshUpToDate; }
	const Mesh& GetSolidMesh() const { return m_SolidMesh; }
