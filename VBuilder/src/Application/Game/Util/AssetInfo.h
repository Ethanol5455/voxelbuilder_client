...
struct ItemInfo
{
	...
	TextureCoordinates TopTexCoords = Texture::ExtractCoordinates(glm::vec2(10, 10), { 0,9 });
	TextureCoordinates SideTexCoords = Texture::ExtractCoordinates(glm::vec2(10, 10), { 0,9 });
	TextureCoordinates BottomTexCoords = Texture::ExtractCoordinates(glm::vec2(10, 10), { 0,9 });
};
